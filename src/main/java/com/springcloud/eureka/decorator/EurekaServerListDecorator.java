...
public class EurekaServerListDecorator extends DomainExtractingServerList {
    ...
    public List<DiscoveryEnabledServer> getInitialListOfServers() {
        ...
        logger.debug("============>EurekaServerListDecorator.getInitialListOfServers==================="+ JSONObject.toJSONString(list));
        return list;
    }
    ...
    public List<DiscoveryEnabledServer> getUpdatedListOfServers() {
        ...
        while (iterator.hasNext()){
            ...
            if(whiteList.contains(host)){
                ...
                iterator.remove();
                logger.debug("current server can not send request to server:"+serviceId+" ip："+host);
            }
        }


        logger.debug("============>EurekaServerListDecorator.getUpdatedListOfServers==================="+ JSONObject.toJSONString(discoveryEnabledServers));
